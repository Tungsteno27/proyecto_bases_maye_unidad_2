...
/**
 * Clase que realiza operaciones sobre la tabla clientes (e hijos) de la base de datos
 * @author Tungs
 */
public class ClienteDAO implements IClienteDAO{
    ...
    /**
     * Método que inserta un cliente en la base de datos, como se maneja herencia si el cliente es un cliente frecuente igual se inserta el Cliente padre
     * @param cliente el cliente a insertar, puede ser de cualquiera de las clases hijas
    ...
    /**
     * Método que calcula las visitas de un cliente accediendo a sus comandas registradas
